...
SEARCH_URL = "http://www.eworldship.com/index.php?m=content&c=index&a=lists&catid=818" 

PAGE_URL = "http://www.eworldship.com/index.php?m=content&c=index&a=lists&catid=818&page={page}"

class GuochuanSearchSpider(Spider):
    """usage: scrapy crawl guochuan_news_shuanshi_spider -a start_datetime="2014-11-01 00:00:00" -a end_datetime="2014-12-01 00:00:00" --loglevel=INFO
    """
    name = "guochuan_news_chuanshi_spider"

    def __init__(self, start_datetime, end_datetime):
        self.start_ts = self.datetime2ts(start_datetime)
        self.end_ts = self.datetime2ts(end_datetime)
        self.source_website = "guochuan_news_spider"
