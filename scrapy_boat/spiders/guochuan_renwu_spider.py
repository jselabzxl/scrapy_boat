...
class GuochuanSearchSpider(Spider):
    """usage: scrapy crawl guochuan_renwu_spider -a start_datetime="2014-11-01 00:00:00" -a end_datetime="2014-12-01 00:00:00" --loglevel=INFO
    """
    name = "guochuan_renwu_spider"
    ...
    def resp2items(self, resp):
        ...
        for result in search_results:
            ...
            keys = ScrapyRenwuItem.RESP_ITER_KEYS_GUOCHUAN_NEWS
